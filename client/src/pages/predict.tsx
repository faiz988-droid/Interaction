    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
      <div className="mb-6">
        ...
        <p className="text-neutral-700">
          Predict potential interactions between miRNAs and lncRNAs by entering
          sequences.
        </p>
      </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="rnafold">
                          Vienna RNAfold (Energy-based)
                        </SelectItem>
                        <SelectItem value="rnahybrid">
                          RNAhybrid (Specialized for miRNA)
                        </SelectItem>
                      </SelectContent>
                    </Select>
              ...
              <div className="flex justify-end">
                <Button
                  ...
                  disabled={
                    isPending ||
                    !formData.mirnaSequence ||
                    !formData.lncrnaSequence
                  }
                >
              ...
              <div className="bg-neutral-50 p-4 rounded-md">
                <div className="grid md:grid-cols-4 gap-4 text-sm">
                  <div>
                    ...
                    <p>
                      {predictionResult.mirnaName || "Custom sequence"} (
                      {predictionResult.mirnaSequence.length} nt)
                    </p>
                  </div>
                  <div>
                    <p className="font-medium">lncRNA Region:</p>
                    <p>
                      {predictionResult.lncrnaName || "Fragment"} (
                      {predictionResult.lncrnaSequence.length} nt)
                    </p>
                  </div>
                  <div>
                    <p className="font-medium">Binding Position:</p>
                    <p>
                      {predictionResult.bindingStart + 1}-
                    ...
                    <table className="w-full text-sm text-left">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            {predictionResult.bindingDetails.complementaryPairs}
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td>
                            {predictionResult.bindingDetails.guWobblePairs}
                          </td>
                        </tr>
                        <tr>
                          <td className="py-1 font-medium">Bulges:</td>
                          <td>
                            {predictionResult.bindingDetails.bulges} (lncRNA)
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    ...
                    <table className="w-full text-sm text-left">
                      <tbody>
                        <tr>
                          ...
                          <td>
                            {predictionResult.thermodynamics.freeEnergy.toFixed(
                              1,
                            )}{" "}
                            kcal/mol
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            {predictionResult.thermodynamics.stabilityScore}
                          </td>
                        </tr>
                        <tr>
                          <td className="py-1 font-medium">Accessibility:</td>
                          <td>
                            {predictionResult.thermodynamics.accessibility.toFixed(
                              2,
                            )}{" "}
                            (Highly accessible)
                          </td>
                  ...
                  <div className="text-center">
                    <div className="border-2 border-dashed border-neutral-300 p-8 rounded-md">
                      <p className="text-neutral-600">
                        Structure visualization is not available for the
                        standard algorithm
                      </p>
                      <p className="text-neutral-500 text-sm mt-2">
                        Use RNAhybrid or RNAfold algorithm for structure
                        prediction
                      </p>
                    </div>
                  </div>
                    ...
                    >
                      {predictionResult.score >= 70
                        ...
                        : predictionResult.score >= 50
                          ? "Medium"
                          : "Low"}{" "}
                      confidence prediction ({predictionResult.score}/100)
                    </span>{" "}
                    -
                    {predictionResult.score >= 70
                      ? " This interaction is likely to occur in vivo."
                      : predictionResult.score >= 50
                        ? " This interaction may occur under specific conditions."
